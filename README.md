...
1. Build and iterate inside Native.Builder.
2. Keep the generated source code synced to GitHub.
3. Avoid committing secrets or build artifacts.
4. Review source changes before publishing major versions.
5. Use small stabilization passes before adding new features.
...
If scripts differ in `package.json`, use the scripts defined there.
...
Natively Profit Scout is an active Native.Builder project.
