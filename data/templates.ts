...
export const opportunityTemplates: Record<OpportunityType, OpportunityTemplate> = {
  ...
  sales_followup: {
    ...
    businessProblem: 'Sales reps spend too much time on manual follow-up, losing leads in the process',
    ...
    requiredFeatures: 'Email integration, multi-step sequences, SMS support, call reminders, analytics',
  ...
  inventory_work_order_tracker: {
    ...
    requiredFeatures: 'Inventory tracking, work order creation, status tracking, search, user roles',
    suggestedDemoAngle: 'Create a work order, track inventory count, show status board in 5 minutes',
